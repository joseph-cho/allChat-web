...
allChat.prototype.initFirebase = function() {
...
allChat.prototype.loadMessages = function() {
...
allChat.prototype.setImageUrl = function(imageUri, imgElement) {
  //If the image is a Cloud Storage URI we fetch the URL
  if (imageUri.startsWith('gs://')) {
    imgElement.src = allChat.LOADING_IMAGE_URL; //Display a laoding image first
...
allChat.prototype.saveImageMessage = function(event) {
  ...
  if (this.checkSignedInWithMessage()) {
    ...
    this.messagesRef.push({
      name: currentUser.displayName,
      imageUrl: allChat.LOADING_IMAGE_URL,
      photoUrl: currentUser.photoUrl || '/images/profile_placeholder.png'
    }).then(function(data) {
...
allChat.prototype.signIn = function() {
...
allChat.prototype.signOut = function() {
  // Sign out of Firebase.
  this.auth.signOut();
};

// Triggers when the auth state change for instance when the user signs-in or signs-out.
allChat.prototype.onAuthStateChanged = function(user) {
...
allChat.prototype.checkSignedInWithMessage = function() {
...
allChat.prototype.saveMessagingDeviceToken = function() {
  firebase.messaging().getToken().then(function(currentToken) {
    if(currentToken) {
      console.log('Got FCM device token:', currentToken);
      //Saving the device token to datastore
...
allChat.prototype.requestNotificationsPermissions = function() {
...
// fields.
allChat.prototype.toggleButton = function() {
...
allChat.prototype.checkSetup = function() {
